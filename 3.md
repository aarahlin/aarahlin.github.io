...
<p>
Since your .csv file contains lat longs, Google Earth Engine assumes that it is a FeatureCollection (vector file with points, lines, polygons) rather than an ImageCollection (like the Landsat rasters we worked with). The AOU code for Blue-gray Gnatcatcher is <code>bggn</code>, so create a variable <code>bggn</code> and set it equal to your FeatureCollection, which is the file path to your file.
</p>
...
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:6px;">
  <div id="hint" style="visibility:hidden; height:auto; background-color:#f0f0f0; border-left:4px solid #ccc; padding:2px 6px; margin:0px; flex:1;">
    You will need to use <code>ee.FeatureCollection()</code> to load your uploaded .csv file into Earth Engine.
  </div>
