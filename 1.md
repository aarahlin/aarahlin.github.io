...
This is an example of a dictionary: <code>var my_dictionary = {'food':'bread', 'color':'red', 'number':42};</code> <br>
<br> <br> Square brackets [ ] can be used to access dictionary items by key.
<code> print(my_dictionary['color']); </code>

<br> <br> Or you can use the dot notation to get the same result. We'll use dot notation a lot in GEE. <br>
<code>print(my_dictionary.color);</code>
