...
Now try creating a string. Create a variable called <code>myString</code> and set it equal to "Hello World". Then, use the print() function to print it to the console. <!-- CODE Row 2 -->
<div style="display:flex; justify-content:space-between; align-items:center;">
