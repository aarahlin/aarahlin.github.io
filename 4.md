...
<div style="display:flex; justify-content:space-between; align-items:center;">
  <div id="code29" style="visibility:hidden; height:auto; background-color:#f0f0f0; border-left:4px solid #ccc; padding:2px 6px; margin:0px; flex:1;">
    var missouriBox = ee.Geometry.Rectangle([-93.5123, 36.2114, -89.1032, 40.3299]);<br>var clipped_mosaic = my_mosaic.clip(missouriBox);<br>Map.addLayer(clipped_mosaic, visualization, 'Clipped May 2024 Mosaic');<br>Map.centerObject(missouriBox, 6);</code>
  </div>
