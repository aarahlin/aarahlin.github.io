...
<p>Use the Layers button on the map to toggle the transparency of the optical and thermal Landsat data you just mapped. Does it make sense that red represents the hottest land surface temperatures in St. Louis? </p>
