...
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:6px;">
  <div id="hint21" style="visibility:hidden; height:80px; width:100%; background-color:#f0f0f0; border-left:4px solid #ccc; padding:2px 6px; margin:0px;">
...
<div style="display:flex; justify-content:space-between; align-items:center;">
  <div id="code21" style="visibility:hidden; height:80px; width:100%; background-color:#f0f0f0; border-left:4px solid #ccc; padding:2px 6px; margin:0px;">
...
<!-- HINT Row -->
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:6px;">
  <div id="hint22" style="visibility:hidden; height:80px; width:100%; background-color:#f0f0f0; border-left:4px solid #ccc; padding:2px 6px; margin:0px;">
...
<!-- CODE Row -->
<div style="display:flex; justify-content:space-between; align-items:center;">
  <div id="code22" style="visibility:hidden; height:80px; width:100%; background-color:#f0f0f0; border-left:4px solid #ccc; padding:2px 6px; margin:0px;">
...
<!-- HINT Row -->
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:6px;">
  <div id="hint23" style="visibility:hidden; height:80px; width:100%; background-color:#f0f0f0; border-left:4px solid #ccc; padding:2px 6px; margin:0px;">
...
<!-- CODE Row -->
<div style="display:flex; justify-content:space-between; align-items:center;">
  <div id="code23" style="visibility:hidden; height:80px; width:100%; background-color:#f0f0f0; border-left:4px solid #ccc; padding:2px 6px; margin:0px;">
...
<!-- HINT Row -->
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:6px;">
  <div id="hint24" style="visibility:hidden; height:80px; width:100%; background-color:#f0f0f0; border-left:4px solid #ccc; padding:2px 6px; margin:0px;">
...
<!-- CODE Row -->
<div style="display:flex; justify-content:space-between; align-items:center;">
  <div id="code24" style="visibility:hidden; height:80px; width:100%; background-color:#f0f0f0; border-left:4px solid #ccc; padding:2px 6px; margin:0px;">
...
<!-- HINT Row -->
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:6px;">
  <div id="hint25" style="visibility:hidden; height:80px; width:100%; background-color:#f0f0f0; border-left:4px solid #ccc; padding:2px 6px; margin:0px;">
...
<!-- CODE Row -->
<div style="display:flex; justify-content:space-between; align-items:center;">
  <div id="code25" style="visibility:hidden; height:80px; width:100%; background-color:#f0f0f0; border-left:4px solid #ccc; padding:2px 6px; margin:0px;">
...
<!-- HINT Row -->
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:6px;">
  <div id="hint26" style="visibility:hidden; height:80px; width:100%; background-color:#f0f0f0; border-left:4px solid #ccc; padding:2px 6px; margin:0px;">
...
<!-- CODE Row -->
<div style="display:flex; justify-content:space-between; align-items:center;">
  <div id="code26" style="visibility:hidden; height:80px; width:100%; background-color:#f0f0f0; border-left:4px solid #ccc; padding:2px 6px; margin:0px;">
